...
SOURCE_LEFT = os.path.join(BASE_DIR, "..", "..", "assets", "Touch Quest 2", "TouchQuest2_Models", "oculus_quest2_controller_left")
SOURCE_RIGHT = os.path.join(BASE_DIR, "..", "..", "assets", "Touch Quest 2", "TouchQuest2_Models", "oculus_quest2_controller_right")
