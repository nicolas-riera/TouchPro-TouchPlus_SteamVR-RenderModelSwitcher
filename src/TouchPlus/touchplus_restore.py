...
SOURCE_LEFT = os.path.join(BASE_DIR, "..", "..", "assets", "Touch Plus", "TouchPlus_Models", "oculus_quest_plus_controller_left")
SOURCE_RIGHT = os.path.join(BASE_DIR, "..", "..", "assets", "Touch Plus", "TouchPlus_Models", "oculus_quest_plus_controller_right")
